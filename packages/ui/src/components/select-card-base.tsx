...
function SelectCardIcon({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      className={cn(
        "flex size-10 shrink-0 items-center justify-center rounded-lg border bg-muted/50 text-muted-foreground transition-colors group-data-[state=checked]:border-primary/20 group-data-[state=checked]:bg-primary/10 group-data-[state=checked]:text-primary group-data-[state=on]:border-primary/20 group-data-[state=on]:bg-primary/10 group-data-[state=on]:text-primary",
        className
      )}
