...
function FilterInput<T = unknown>({
  ...
  return (
    <div
      ...
      data-component="filters-input-wrapper"
...
function FilterValueSelector<T = unknown>({
  ...
  if (field.type === "time") {
    if (operator === "between") {
      ...
      return (
        <div className="flex items-center" data-component="filters-item" data-slot="filters-item">
          <FilterInput
          ...
          <div
            ...
            data-component="filters-between"
