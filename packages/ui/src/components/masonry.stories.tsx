...
const meta = {
	...
	argTypes: {
		...
		columnWidth: {
			control: "number",
			description: "Minimum width of columns (responsive, auto-calculates column count)",
		},
		gap: {
			control: "number",
			description: "Gap between items in pixels, or object with column/row values",
		},
		linear: {
			control: "boolean",
			description: "Linear mode: items flow left-to-right, allowing same-height rows",
		},
	},
	args: {
...
const items = [
	...
	{ id: "2", title: "Item 2", description: "Second item with more text to demonstrate variable heights" },
	{ id: "3", title: "Item 3", description: "Third item" },
	{ id: "4", title: "Item 4", description: "Fourth item with even more content to show how masonry handles different heights efficiently" },
...
const contentItems = [
	...
	},
	{
		...
		author: "Emma Wilson",
		image: "https://images.unsplash.com/photo-1586281380349-632531db7ed4?w=400&h=350&fit=crop",
	...
	},
	{
		...
		author: "Lisa Park",
		image: "https://images.unsplash.com/photo-1507721999472-8ed4421c4af2?w=400&h=280&fit=crop",
		tags: ["CSS", "Responsive"],
		date: "2024-03-05",
	},
];
