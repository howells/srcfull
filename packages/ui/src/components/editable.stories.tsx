...
export const TriggerModes: Story = {
  parameters: {
    ...
    docs: {
      description: {
        story:
          "Different trigger modes: button trigger, double-click trigger, and no explicit trigger (always editable).",
      },
    },
  },
  render: () => (
    <div className="w-96 space-y-4">
      <Editable
        defaultValue="Click Edit button to edit"
        placeholder="Enter your text here"
      >
...
export const ValidationStates: Story = {
  parameters: {
    ...
    docs: {
      description: {
        story:
          "Editable supports various validation states: disabled, read-only, required, and invalid.",
      },
    },
  },
  render: () => (
    <div className="w-96 space-y-4">
      ...
      <Editable defaultValue="" placeholder="This field is required…" required>
        <EditableLabel>
      ...
      <Editable defaultValue="invalid@" invalid placeholder="Enter valid email">
...
export const PlaceholderAndEmpty: Story = {
  parameters: {
    ...
    docs: {
      description: {
        story:
          "Editable fields can show a placeholder when empty, useful for prompting user input.",
      },
    },
  },
  render: () => (
...
export const InlineEditing: Story = {
  parameters: {
    ...
    docs: {
      description: {
        story:
          "Example of using multiple editable fields together in a form-like layout.",
      },
    },
  },
  render: () => (
