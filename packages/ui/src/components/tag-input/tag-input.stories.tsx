			...
			<div className="space-y-4">
				...
				{tags.length > 0 && (
					<div className="space-y-2">
						<div className="text-sm font-medium">Tagged Items:</div>
						{tags.map((tag) => (
	...
	render: () => {
		...
		return (
			<div className="space-y-4">
				...
				{loading && (
					<div className="text-xs text-muted-foreground">Searching library…</div>
				)}
				{tags.length > 0 && (
					<div className="text-sm text-muted-foreground">
...
export const MultipleInputs: Story = {
	render: () => (
		<div className="space-y-6">
			<div>
				<label className="mb-2 block text-sm font-medium">Design Styles</label>
				<TagInput
			...
			<div>
				<label className="mb-2 block text-sm font-medium">Room Types</label>
				<TagInput
			...
			<div className="space-y-6">
				<div>
					...
					<div className="mt-2 text-xs text-muted-foreground">
						<div>Styles: modern, minimalist, industrial, scandinavian, contemporary</div>
				...
				{tags.length > 0 && (
					<div className="space-y-2">
						<div className="text-sm font-medium">Applied Tags:</div>
